...
void loop() {
  ...
  int adc3 = analogRead(VOLTAGE_PIN_3);

  float v1 = ((adc1 / 4095.0) * 3.3) * ((47.0 + 10.0) / 10.0);
  float v2 = ((adc2 / 4095.0) * 3.3) * ((47.0 + 10.0) / 10.0);
  float v3 = ((adc3 / 4095.0) * 3.3) * ((47.0 + 10.0) / 10.0);

  float pack1 = v1;
  float pack2 = v2 - pack1;
  float pack3 = v3 - pack2;
